...
![[Pasted image 20260730150014.png]]

## **Спостереження відмінностей і поведінки**

![[Pasted image 20260730150031.png]]
...
![[Pasted image 20260730150139.png]]

Як результат - цей крок пройдено:

![[Pasted image 20260730150204.png]]
...
![[Pasted image 20260730150239.png]]
...
Перегляньте профіль іншого користувача, скориставшись тим самим альтернативним шляхом, який ви вже використовували для перегляду власного профілю. Скористайтеся кнопкою **"View Profile"** (Переглянути профіль), перехопіть та модифікуйте запит, щоб побачити дані іншої особи. Крім того, ви можете спробувати просто надіслати ручний **GET-запит** через браузер. Для цього потрібно знайти відпоівдний запит, та модифікувати його в "Intruder": [![step06](https://github.com/dimdimuzun/CS-practice/raw/main/InsecureDirectObjectReference/idor06.png)](https://github.com/dimdimuzun/CS-practice/blob/main/InsecureDirectObjectReference/idor06.png) Результат запуску атаки "intuder" дасть схожі результати: ![[Pasted image 20260730150511.png]]
...
![[Pasted image 20260730150531.png]]
...
![[Pasted image 20260730150544.png]]
![[Pasted image 20260730150607.png]]
